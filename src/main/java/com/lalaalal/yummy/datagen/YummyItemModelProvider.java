...
import static com.lalaalal.yummy.YummyMod.prefix;
...
public class YummyItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        simpleBlock(YummyBlocks.SOUL_CRAFTER);
        simpleItem(YummyItems.BUNNY_CHEST_ITEM);
        simpleItem(YummyItems.EBONY_BOAT_ITEM);
        simpleItem(YummyItems.EBONY_CHEST_BOAT_ITEM);
        trimmedArmorItem(YummyItems.PURIFIED_SOUL_HELMET);
        trimmedArmorItem(YummyItems.PURIFIED_SOUL_CHESTPLATE);
        trimmedArmorItem(YummyItems.PURIFIED_SOUL_LEGGINGS);
        trimmedArmorItem(YummyItems.PURIFIED_SOUL_BOOTS);
    ...
    private void trimmedArmorItem(RegistryObject<? extends Item> itemRegistryObject) {
        final String MOD_ID = YummyMod.MOD_ID; // Change this to your mod id
